...
- 2026-09-03 — 현재 소스·검증·운영 경계를 다시 대조해 최상위 README와 공개 RELIC 포트폴리오·HTML CV·PDF CV를 최신화하고 CI와 같은 전체 source/offline 회귀를 통과시켰다. 외부 서비스나 장치는 시작하지 않았으며, 공개 전 이력 검사를 거쳐 전체 변경을 GitHub `main`에 비강제 fast-forward로 동기화했다. [근거](obsidian://open?vault=docs&file=worklog%2F2026-09-03)
